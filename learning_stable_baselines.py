...
#import gym_wrapper.base_gym_env
...
# AVAILABLE_ENVS = [
#     {'VizdoomBasic-v0': EnvSpec(id='VizdoomBasic-v0', entry_point='vizdoom.gymnasium_wrapper.gymnasium_env_defns:VizdoomScenarioEnv', reward_threshold=None, nondeterministic=False, max_episode_steps=None, order_enforce=True, autoreset=False, disable_env_checker=False, apply_api_compatibility=False, kwargs={'scenario_file': 'basic.cfg'}, namespace=None, name='VizdoomBasic', version=0, additional_wrappers=(), vector_entry_point=None)},
#     { 'VizdoomCorridor-v0': EnvSpec(id='VizdoomCorridor-v0', entry_point='vizdoom.gymnasium_wrapper.gymnasium_env_defns:VizdoomScenarioEnv', reward_threshold=None, nondeterministic=False, max_episode_steps=None, order_enforce=True, autoreset=False, disable_env_checker=False, apply_api_compatibility=False, kwargs={'scenario_file': 'deadly_corridor.cfg'}, namespace=None, name='VizdoomCorridor', version=0, additional_wrappers=(), vector_entry_point=None) }  
# ]
...
# env
# for env in [env_spec.id for env_spec in gym.envs.registry.items()]
# if "Vizdoom" in env
...
def main(args):
    ...
    #env = gym.make("VizdoomHealthGatheringSupreme-v0", render_mode="human")
    agent = PPO("MultiInputPolicy", env, n_steps=N_STEPS, verbose=1)
